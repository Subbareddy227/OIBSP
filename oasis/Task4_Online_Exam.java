...
public class Online_Quiz
{
    ...
    private static void initializeQuestions() //storing question with options and answers in a list
    {
        ...
        questions.add(new Question("What does CPU stand for?", List.of("Central Process Unit", "Central Processing Unit", "Computer Personal Unit", "Computer processing unit"), 2));
        questions.add(new Question("Which of the following is a programming language?", List.of("Chennai", "Bengaluru", "Delhi", "Mumbai"), 2));
